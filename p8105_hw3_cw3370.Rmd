...
ggplot(distribution_response,aes(x = Response, y = Data_value))+
  ...
  facet_grid(1.~Year)
```
<font size = 4 face="Times New Roman">The data value of "Excellent" and "Poor"  didn't change a lot over time. The data value of "Fair" and "Good",decrease a little. The data value of "Very Good" increase a lot.It seems that many people who chose "Fair" and "Good" in 2006 choose "Very Good" in 2010.</font>
